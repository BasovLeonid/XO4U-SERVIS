        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Настройки подключения Яндекс Метрики</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Для подключения аккаунта Яндекс Метрики к API нашего приложения, перейдите по следующей ссылке:</p>
                            <a href="{{ $authUrl }}" class="btn btn-primary btn-lg btn-block" target="_blank">
                                <i class="fas fa-chart-line mr-2"></i>Подключить Яндекс Метрику
                            </a>
                            
                            <div class="alert alert-info mt-4">
                                <h5><i class="fas fa-info-circle mr-2"></i>Инструкция по подключению:</h5>
                                <ol class="mb-0">
                                    <li>Нажмите на кнопку "Подключить Яндекс Метрику"</li>
